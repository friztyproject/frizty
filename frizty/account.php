...
<?php 
	...
	if (isset($_POST['submit'])) {
		...
		if (empty($errors)) {
			...
			verify_query($result_set,$connection);
		...
		<div class="row px-3 my-5">
			<div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
				...
				<div class="card-body">
					...
					<form class="form-box px-3" action="account.php" method="post">
				...
				?>
						...
						<div class="text-center mb-2">
							Don't have Account     <a href="add-user.php" class="register-link">Register now!</a>
